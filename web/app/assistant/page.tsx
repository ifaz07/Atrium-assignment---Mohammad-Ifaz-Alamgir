...
export default function AssistantPage() {
  const [entries, setEntries] = useState<Entry[]>([{ from: 'Atrium assistant', text: 'Ask about upcoming sessions, bookings, or your credits. I use your current sign-in automatically.' }]);
